...
class Cabins( object ):
    ...
    def __init__(self, dbpath):
        ...
        db.open(self.dbpath)
        self.list_cabins = [u"Inserisci Cabina", u"Inserisci Strumenti", u"Inserisci Ticket" ,u"View Cabine" ,u"View Strumenti" ,u"View Ticket" , u"Back"]
        ## Bool
    ...
    def insert_cabins(self):
        ...
        if self.isSaved():
            ...
            sql_string = u"INSERT INTO cabine (nome, regione, provincia, indirizzo, strumento, note) VALUES ('%s', '%s', '%s', '%s', '%s', '%s')" % (nome, regione, provincia, indirizzo, strumento, note)
            try:
